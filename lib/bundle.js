...
var Ship2 = __webpack_require__(8);
var Util = __webpack_require__(0);
...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function add(object) {
      ...
      } else if (object instanceof Ship2) {
        this.ships.push(object);
      } else {
    ...
    value: function remove(object) {
      if (object instanceof Bullet) {
        ...
        this.asteroids.splice(this.ships.indexOf(object), 1);
      } else if (object instanceof Ship) {
...
var GameView = function () {
  ...
  _createClass(GameView, [{
    ...
    value: function bindKeyHandlers2() {
      ...
      Object.keys(GameView.MOVES2).forEach(function (k) {
        var move = GameView.MOVES2[k];
        key(k, function () {
          ship.power(move);
        });
      });
...
var Ship2 = function (_MovingObject) {
  _inherits(Ship2, _MovingObject);

  function Ship2(options) {
    _classCallCheck(this, Ship2);

    options.vel = options.vel || [0, 0];

    var _this = _possibleConstructorReturn(this, (Ship2.__proto__ || Object.getPrototypeOf(Ship2)).call(this, options));

    _this.pos = options.pos;
    _this.image = new Image();
    _this.image.src = "./image/PNG/ufoGreen.png";
    _this.size = 30;
    return _this;
  }

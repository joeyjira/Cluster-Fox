...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var playerOne = document.getElementsByClassName("player-one-score")[0];
  var playerTwo = document.getElementsByClassName("player-two-score")[0];
  ...
  var scoreOne = document.createElement("p");
  var scoreTwo = document.createElement("p");
  scoreOne.textContent = "Score: " + game.ships[0].score;
  scoreTwo.textContent = "Score: " + game.ships[1].score;

  playerOne.appendChild(scoreOne);
  playerTwo.appendChild(scoreTwo);
